...
- 🪟 **Window Guard (Fenstersperre)**: Automatic room-wide ventilation pause when windows are open.
  - ✅ **Smart Pause**: If any window in the room is opened (detected via a Home Assistant binary sensor group), all VentoSync units in that room immediately stop their fans to prevent heat loss or energy waste.
