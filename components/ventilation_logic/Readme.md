...
| **`room_fusion.h`** | **Room-wide fusion helpers (`ventosync::room`)**: NaN-aware maxima of local and fresh (≥ 5 min, two heartbeats) ESP-NOW peer values for CO2, humidity, PID demand and the room AC state. |
