...
echo "=================================================="
esphome upload esp_wohnraumlueftung.yaml --device 192.168.178.225

echo ""
echo "=================================================="
echo "🚀 Starte Upload auf Gerät WRG Büro (192.168.178.237)..."
echo "=================================================="
esphome upload esp_wohnraumlueftung.yaml --device 192.168.178.237

echo ""
echo "=================================================="
echo "🚀 Starte Upload auf Gerät WRG DG Wohnraum (192.168.178.244)..."
echo "=================================================="
esphome upload esp_wohnraumlueftung.yaml --device 192.168.178.244
